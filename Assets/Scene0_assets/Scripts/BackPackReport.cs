...
public class BackPackReport : MonoBehaviour
{
    public GameObject Backpack, CanvasLieTestResult, CanvasReport;
    ...
    void Start()
    {
        ...
        // Test
        backpackIcon.onClick.AddListener(() => Debug.Log("backpackicon clicked"));
    }
